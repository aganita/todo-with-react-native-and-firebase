...
- [Firebase](https://www.firebase.com/docs/web/guide/setup.html) `2.4.2` !!!IMPORTANT newer versions of Firebase did not support React Native on the day this app was created
